...
compDescription=$(lshw -class system | grep 'description:' | awk '{print $2}')
...
#-z test command is used to check if the data is available or not by testing the variable and checking if it's empty or not. If empty an error is displayed
compManufacture=$(lshw -class system | grep 'vendor:' | head -1 | awk '{$1=""; print $0}')
...
#-z test command is used to check if the data is available or not' by testing the variable and checking if it's empty or not. If empty an error is displayed
compSerial=$(lshw -class system | grep 'serial:' | awk '{$1=""; print $0}')
